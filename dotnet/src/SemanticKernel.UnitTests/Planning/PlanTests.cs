...
//        var resultContent = await result.ReadContentAsync();

//        // Assert
//        Assert.NotNull(result);
//        Assert.Equal("Some input", resultContent);

//        plan = new Plan(goal);
//        // Act
//        context.Variables.Update("other input");
//        result = await plan.InvokeAsync(context);
//        resultContent = await result.ReadContentAsync();

//        // Assert
//        Assert.NotNull(result);
//        Assert.Equal("other input", resultContent);
//    }
