...
/// <summary>
/// Provides extension methods to work with an <see cref="FunctionResponseData"/> instance.
/// </summary>
public static class FunctionResponseDataExtensions
{
    /// <summary>
    ...
    public static void WriteString(this FunctionResponseData response, string value, Encoding? encoding = null)
    {
        if (response is null)
        {
    ...
    public static Task WriteStringAsync(this FunctionResponseData response, string value, Encoding? encoding = null)
    {
    ...
    /// <param name="encoding">The encoding to use when writing the string. Defaults to UTF-8</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    public static Task WriteStringAsync(this FunctionResponseData response, string value, CancellationToken cancellationToken, Encoding? encoding = null)
    {
        if (response is null)
        {
            throw new ArgumentNullException(nameof(response));
    ...
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the operation.</param>
    /// <returns>A <see cref="ValueTask"/> that represents the asynchronous operation.</returns>
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance, HttpStatusCode statusCode,
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the operation.</param>
    /// <returns>A <see cref="ValueTask"/> that represents the asynchronous operation.</returns>
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance, string contentType, CancellationToken cancellationToken = default)
    {
        if (response is null)
        {
            throw new ArgumentNullException(nameof(response));
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the operation.</param>
    /// <returns>A <see cref="ValueTask"/> that represents the asynchronous operation.</returns>
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance, string contentType, HttpStatusCode statusCode,
        CancellationToken cancellationToken = default)
    {
        if (response is null)
        {
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the operation.</param>
    /// <returns>A <see cref="ValueTask"/> that represents the asynchronous operation.</returns>
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance, ObjectSerializer serializer, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the operation.</param>
    /// <returns>A <see cref="ValueTask"/> that represents the asynchronous operation.</returns>
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance, ObjectSerializer serializer, HttpStatusCode statusCode,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the operation.</param>
    /// <returns>A <see cref="ValueTask"/> that represents the asynchronous operation.</returns>
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance,
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the operation.</param>
    /// <returns>A <see cref="ValueTask"/> that represents the asynchronous operation.</returns>
    public static ValueTask WriteAsJsonAsync<T>(this FunctionResponseData response, T instance, ObjectSerializer serializer, string contentType, HttpStatusCode statusCode, CancellationToken cancellationToken = default)
    {
        if (response is null)
        {
            throw new ArgumentNullException(nameof(response));
    ...
    public static void WriteBytes(this FunctionResponseData response, byte[] value)
    {
        if (response is null)
        {
            throw new ArgumentNullException(nameof(response));
    ...
    /// <param name="value">The byte content to write to the request body.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    public static Task WriteBytesAsync(this FunctionResponseData response, byte[] value)
    {
    ...
    /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    public static Task WriteBytesAsync(this FunctionResponseData response, byte[] value, CancellationToken cancellationToken)
    {
        if (response is null)
        {
            throw new ArgumentNullException(nameof(response));
    ...
    private static ObjectSerializer GetObjectSerializer(FunctionResponseData response)
    {
        return response.FunctionContext.InstanceServices.GetService<WorkerOptions>()?.Serializer
