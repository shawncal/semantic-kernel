...
public sealed class InputConverterAttribute : Attribute
{
    ...
    /// <exception cref="InvalidOperationException">Thrown when the converterType parameter value is a type which has not implemented Microsoft.SemanticKernel.vNext.Converters.IInputConverter</exception>
