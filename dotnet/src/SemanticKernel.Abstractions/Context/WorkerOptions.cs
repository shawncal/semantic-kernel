...
public class WorkerOptions
{
    ...
    {
        get => this.GetBoolCapability(nameof(this.EnableUserCodeException));
        set => this.SetBoolCapability(nameof(this.EnableUserCodeException), value);
    }
    ...
    {
        get => this.GetBoolCapability(nameof(this.IncludeEmptyEntriesInMessagePayload));
        set => this.SetBoolCapability(nameof(this.IncludeEmptyEntriesInMessagePayload), value);
    }

    private bool GetBoolCapability(string name)
    {
        return this.Capabilities.TryGetValue(name, out string? value) && bool.TryParse(value, out bool b) && b;
    }
    ...
    private void SetBoolCapability(string name, bool value)
    {
        if (value)
        {
            this.Capabilities[name] = bool.TrueString;
        }
        else
        {
