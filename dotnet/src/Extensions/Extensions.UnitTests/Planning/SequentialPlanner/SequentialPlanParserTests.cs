...
<plan>
    ...
    <function.email.SendEmailAsync input=""$TRANSLATED_SUMMARY"" email_address=""$EMAIL_ADDRESS""/>
        ...
        // Act
        var plan = planString.ToPlanFromXml(goal, SequentialPlanParser.GetSkillFunction(kernel));
    ...
    public void InvalidPlanExecutePlanReturnsInvalidResult()
    {
        ...
        // Act
        Assert.Throws<SKException>(() => planString.ToPlanFromXml(GoalText, SequentialPlanParser.GetSkillFunction(kernel)));
    }
    ...
    public void CanCreatePlanWithTextNodes(string goalText, string planText)
    {
        ...
        // Act
        var plan = planText.ToPlanFromXml(goalText, SequentialPlanParser.GetSkillFunction(kernel));
    ...
    public void CanCreatePlanWithInvalidFunctionNodes(string planText, bool allowMissingFunctions)
    {
        ...
        {
            // it should not throw
            var plan = planText.ToPlanFromXml(string.Empty, SequentialPlanParser.GetSkillFunction(kernel), allowMissingFunctions);
        ...
        {
            Assert.Throws<SKException>(() => planText.ToPlanFromXml(string.Empty, SequentialPlanParser.GetSkillFunction(kernel), allowMissingFunctions));
        }
    }
    ...
    public void CanCreatePlanWithOpenApiPlugin(string planText)
    {
        ...
        // Act
        var plan = planText.ToPlanFromXml(string.Empty, SequentialPlanParser.GetSkillFunction(kernel));
